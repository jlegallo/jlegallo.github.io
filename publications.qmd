...
- Dabou, Y., Le Gallo, J., Védrine, L. (forthcoming). [How agricultural subsidies shape local employment: Evidence from the French support policies for mountain areas](https://link.springer.com/journal/168). *Annals of Regional Science*.
- Lei, R., Ay, J.S., Le Gallo, J., Dupré, O. (forthcoming). [Housing wealth beyond prices: Individual portfolios, distant assets, and transfers in France 2011–2022](https://onlinelibrary.wiley.com/journal/14754991). *Review of Income and Wealth*.
- Breuillé, M., Delmas, L., Grivault, C., Le Gallo, J. (forthcoming). [Evaluating fiscal equalization in France: Redistributive performance, cost-efficiency, and needs alignment](https://www.sciencedirect.com/science/article/pii/S3050502X26000094). *Global Challenges & Regional Science*.
